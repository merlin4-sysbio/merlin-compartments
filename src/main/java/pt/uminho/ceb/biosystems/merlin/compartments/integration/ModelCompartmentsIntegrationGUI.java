...
import pt.uminho.ceb.biosystems.merlin.gui.views.annotation.AnnotationCompartmentsView;
import pt.uminho.ceb.biosystems.merlin.services.annotation.AnnotationCompartmentsServices;

public class ModelCompartmentsIntegrationGUI extends javax.swing.JDialog{

	private static final long serialVersionUID = -1L;
	private JPanel jPanel0, jPanel1, jPanel2, jPanel3, jPanel4;
	...
	private void initGUI() {
		...
		this.setSize(500, 500);
		{
			...
			{	
				...
				jPanel4.setBorder(BorderFactory.createTitledBorder("Clone workspace before integrating compartments"));
				GridBagLayout jPanel4Layout = new GridBagLayout();
				jPanel4.setLayout(jPanel4Layout);
				jPanel4Layout.columnWeights = new double[] { 0.0, 0.1, 0.0, 0.0 };
				...
				cloneCheckbox.setToolTipText("select this option if you want to integrate the compartments in a clone of this workspace");;
				cloneCheckbox.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent evt) {
					}
				});
				// add checkbox to panel
				jPanel4.add(cloneCheckbox, new GridBagConstraints(0, 7, 1, 1, 0.0, 0.0,
						GridBagConstraints.WEST,
						GridBagConstraints.BOTH, new Insets(0, 0,
								0, 0), 0, 0));
					...
					jButtonSave.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent arg0) {
							...
							for (@SuppressWarnings("rawtypes") OperationDefinition def : Core.getInstance().getOperations()){
								if (def.getID().equals("operations.ModelCompartmentsIntegrationOperation.ID")){
	...
	private WorkspaceDataTable buildTable(){
		...
		try {
			...
			Map<String, String> compartments = AnnotationCompartmentsServices.getNameAndAbbreviation(this.workspaceName);
