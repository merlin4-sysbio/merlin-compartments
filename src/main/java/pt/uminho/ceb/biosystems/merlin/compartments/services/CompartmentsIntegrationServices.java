...
//
//				ModelGenesServices.loadGenesCompartments(databaseName, idGene, compartmentsDatabaseIDs, statement, primaryCompartment, scorePrimaryCompartment, secondaryCompartments);
//			}
//
